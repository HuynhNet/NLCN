...
@section('content')
	...
	<div class="content-wrapper" style="background-color: white;">
	    <section class="content-header">
	      	<h2>Thêm Người Dùng Từ File Excel</h2>
	    </section>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-push-3">
                        <form action="{{ route('postImport') }}" method="POST" role="form" enctype="multipart/form-data" data-toggle="validator" novalidate="true">
  ...
  <script>
  	var msg = '{{Session::get('add_user_excel')}}';
    var exist = '{{Session::has('add_user_excel')}}';
    if(exist){
        swal({
