...
@section('content')
	...
	<div class="content-wrapper" style="background-color: white;">
	    ...
	    <section class="content-header">
	    	...
	    	<form class="navbar-form navbar-right" role="search" style="padding-top: 4px;" method="GET"
                action="{{ route('getSearchAdmin') }}">
				<div id="custom-search-input">
                    <div class="input-group">
                        <input type="text" name="txt_search" class="search-query form-control" placeholder="Nhập tên, số điện thoại hoặc email admin cần tìm" / style="width: 380px;">
	      	...
	      	<div class="navbar-left" style="padding-top: 10px; padding-left: 10px;"> 
	      		<a href="{{ route('getAddAdmin') }}" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Thêm admin</a>
	      	</div>
	    </section>
	    <br><br><br>
			...
			<table class="table table-bordered table-customize table-responsive table-hover">
			    ...
			    <tbody>
			        ...
			        <tr id="tr_{{ $val->id }}">
			            ...
			            <td data-title="Image"><img src="{{ asset('public/upload/image_admin/'.$val->image) }}" class="img-responsive" alt="Image" style="width: 50px; height: 50px;"></td>
  ...
  <script>
  	var msg = '{{Session::get('add_admin')}}';
    var exist = '{{Session::has('add_admin')}}';
    if(exist){
        swal({
            title: "Đã thêm một tài khoàn admin mới.",
            text: "",
            type: "success",
            timer: 1200,
    ...
    var msg3 = '{{Session::get('delete_all_member')}}';
    var exist3 = '{{Session::has('delete_all_member')}}';
    if(exist3){
        swal({
